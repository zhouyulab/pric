...
f_in = "./AD_ChIP/results/feature/enhancer.count.bed"
f_outtxt = "./figures/results/FigureS4/FigureS4B/Figure4B.txt"
f_outpdf = "./figures/results/FigureS4/FigureS4B/Figure4B.pdf"
