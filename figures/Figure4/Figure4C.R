...
f_EP = "./pRIC/results/TE/AD_pCp_merge/PRE_EP.pair.TE.txt"
f_outtxt = "./figures/results/Figure4/Figure4C/Figure4C.txt"
f_outpdf = "./figures/results/Figure4/Figure4C/Figure4C.pdf"
...
write_tsv(df.EP.count, f_outtxt)
