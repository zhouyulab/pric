...
# f_in <- "~/cluster/CottonRIC/AA_ChIP-seq/results/feature/enhancer.count.bed"
# f_out <- args[2]
...
p
# f_outpdf = "~/cluster/CottonRIC/AA_ChIP-seq/results/feature/enhancer.ROSE.pdf"
